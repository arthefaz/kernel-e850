...
struct pmucal_seq gnss_reset_assert[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_DELAY, "DELAY", 0x10e60000, 0, 0, 1000, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GNSS_INT_EN", 0x11860000, 0x30c4, (0x1 << 3), (0x0 << 3), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "GNSS_INT_EN", 0x11860000, 0x30c4, (0x1 << 5), (0x0 << 5), 0, 0, 0xffffffff, 0),
