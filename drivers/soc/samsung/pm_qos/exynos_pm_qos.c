...
static struct exynos_pm_qos_constraints dnc_tput_max_constraints = {
	...
	.lock = __SPIN_LOCK_UNLOCKED(dnc_throughpu_max),
};
...
static struct exynos_pm_qos_constraints dsp_tput_max_constraints = {
	...
	.lock = __SPIN_LOCK_UNLOCKED(dsp_throughpu_max),
};
...
static struct exynos_pm_qos_constraints tnr_tput_max_constraints = {
	...
	.lock = __SPIN_LOCK_UNLOCKED(tnr_throughpu_max),
};
...
//	trace_pm_qos_update_flags((enum pm_qos_req_action)action, prev_value, curr_value);
