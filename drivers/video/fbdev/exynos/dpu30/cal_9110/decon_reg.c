/*
 * linux/drivers/video/fbdev/exynos/dpu20/cal_9110/decon_reg.c
 *
...
{
	decon_write_mask(id, SRAM_SHARE_ENABLE, SRAM1_SHARE_ENABLE_F, SRAM1_SHARE_ENABLE_F);
	return;
}
