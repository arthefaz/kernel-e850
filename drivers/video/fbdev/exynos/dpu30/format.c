...
static const struct dpu_fmt dpu_formats_list[] = {
	{
		...
		.cs = DPU_COLORSPACE_YUV420,
		.ct = COMP_TYPE_SBWC,
	}, { /* format for lossy SBWC case */
		.name = "NV12M_SBWC_8B_L50",
		.fmt = DECON_PIXEL_FORMAT_NV12M_SBWC_8B_L50,
		.dma_fmt = IDMA_IMG_FORMAT_YVU420_2P,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_8P,
		.bpp = 12,
		.padding = 0,
		...
		.name = "NV12M_SBWC_8B_L75",
		.fmt = DECON_PIXEL_FORMAT_NV12M_SBWC_8B_L75,
		.dma_fmt = IDMA_IMG_FORMAT_YVU420_2P,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_8P,
		.bpp = 12,
		.padding = 0,
		...
		.name = "NV12N_SBWC_8B_L50",
		.fmt = DECON_PIXEL_FORMAT_NV12N_SBWC_8B_L50,
		.dma_fmt = IDMA_IMG_FORMAT_YVU420_2P,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_8P,
		.bpp = 12,
		.padding = 0,
		...
		.name = "NV12N_SBWC_8B_L75",
		.fmt = DECON_PIXEL_FORMAT_NV12N_SBWC_8B_L75,
		.dma_fmt = IDMA_IMG_FORMAT_YVU420_2P,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_8P,
		.bpp = 12,
		.padding = 0,
		...
		.name = "NV12M_SBWC_10B_L40",
		.fmt = DECON_PIXEL_FORMAT_NV12M_SBWC_10B_L40,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
		...
		.name = "NV12M_SBWC_10B_L60",
		.fmt = DECON_PIXEL_FORMAT_NV12M_SBWC_10B_L60,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
		...
		.name = "NV12M_SBWC_10B_L80",
		.fmt = DECON_PIXEL_FORMAT_NV12M_SBWC_10B_L80,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
		...
		.name = "NV12N_SBWC_10B_L40",
		.fmt = DECON_PIXEL_FORMAT_NV12N_SBWC_10B_L40,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
		...
		.name = "NV12N_SBWC_10B_L60",
		.fmt = DECON_PIXEL_FORMAT_NV12N_SBWC_10B_L60,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
		...
		.name = "NV12N_SBWC_10B_L80",
		.fmt = DECON_PIXEL_FORMAT_NV12N_SBWC_10B_L80,
		.dma_fmt = IDMA_IMG_FORMAT_YUV420_P010,
		.dpp_fmt = DPP_IMG_FORMAT_YUV420_P010,
		.bpp = 15,
		.padding = 9,
