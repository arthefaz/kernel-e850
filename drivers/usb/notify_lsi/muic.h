...
#ifdef CONFIG_ERD_IFCONN_NOTIFIER
...
#ifndef CONFIG_ERD_MUIC_LSI_SOLUTION
 enum muic_op_mode {
     OPMODE_MUIC = 0<<0,
     OPMODE_CCIC = 1<<0,
 };
...
#ifdef CONFIG_ERD_MUIC_HV_FORCE_LIMIT
enum {
	HV_9V = 0,
	HV_5V,
};
...
#if defined(CONFIG_ERD_MUIC_LSI_SOLUTION)
