...
#define ENABLE_CLOG_RESERVED_MEM
#endif
...
#define GET_PAFXS_ID(video) ((video->id < IS_VIDEO_PAF1S_NUM) ? 0 \
				: (video->id < IS_VIDEO_PAF2S_NUM) ? 1 : 2)
...
#define mdbgv_sensor(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][SS%d:V]", fmt, ((struct is_device_sensor *)this->device)->instance, GET_SSX_ID(this->video), ##args)

#define mdbgv_3aa(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][3%dS:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_3XS_ID(this->video), ##args)

#define mdbgv_3xc(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][3%dC:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_3XC_ID(this->video), ##args)

#define mdbgv_3xp(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][3%dP:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_3XP_ID(this->video), ##args)

#define mdbgv_3xf(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][3%dF:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_3XF_ID(this->video), ##args)
...
#define mdbgv_ixc(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][I%dC:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_IXC_ID(this->video), ##args)

#define mdbgv_ixp(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][I%dP:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_IXP_ID(this->video), ##args)
...
#define mdbgv_ixw(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][I%dW:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_IXV_ID(this->video), ##args)

#define mdbgv_mexc(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][ME%dC:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_MEXC_ID(this->video), ##args)

#define mdbgv_orbxc(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][ORB%dC:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_ORBXC_ID(this->video), ##args)

#define mdbgv_mcs(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][M%dS:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_MXS_ID(this->video), ##args)

#define mdbgv_mxp(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][M%dP:V]", fmt, ((struct is_device_ischain *)this->device)->instance, GET_MXP_ID(this->video), ##args)

#define mdbgv_vra(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][VRA:V]", fmt, ((struct is_device_ischain *)this->device)->instance, ##args)

#define mdbgv_ssxvc0(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][SSXVC0:V]", fmt, ((struct is_device_sensor *)this->device)->instance, ##args)

#define mdbgv_ssxvc1(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][SSXVC1:V]", fmt, ((struct is_device_sensor *)this->device)->instance, ##args)

#define mdbgv_ssxvc2(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][SSXVC2:V]", fmt, ((struct is_device_sensor *)this->device)->instance, ##args)

#define mdbgv_ssxvc3(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][SSXVC3:V]", fmt, ((struct is_device_sensor *)this->device)->instance, ##args)
...
#define mdbgv_clh(fmt, this, args...) \
	mdbg_common(debug_video, "[%d][CLxS:V]", fmt, ((struct is_device_ischain *)this->device)->instance, ##args)
...
#define mdbgd_group(fmt, group, args...) \
	mdbg_common(debug_device, "[%d][%s:D]", fmt, group->device->instance, group_id_name[group->id], ##args)
