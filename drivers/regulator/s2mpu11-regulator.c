...
static struct dentry *s2mpu11_root = NULL;
static struct dentry *s2mpu11_i2caddr = NULL;
static struct dentry *s2mpu11_i2cdata = NULL;
#endif
...
#ifdef CONFIG_DEBUG_FS
static ssize_t s2mpu11_i2caddr_read(struct file *file, char __user *user_buf,
...
static ssize_t s2mpu11_i2caddr_write(struct file *file, const char __user *user_buf,
					size_t count, loff_t *ppos)
{
	char buf[10] = {0, };
	ssize_t len;
...
static ssize_t s2mpu11_i2cdata_read(struct file *file, char __user *user_buf,
					size_t count, loff_t *ppos)
{
	char buf[10] = {0, };
	ssize_t ret;

	ret = s2mpu11_read_reg(dbgi2c, i2caddr, &i2cdata);
	if (ret)
		return ret;
...
static ssize_t s2mpu11_i2cdata_write(struct file *file, const char __user *user_buf,
					size_t count, loff_t *ppos)
{
	char buf[10] = {0, };
	ssize_t len, ret;
	...
	if (!kstrtou8(buf, 0, &val)) {
		ret = s2mpu11_write_reg(dbgi2c, i2caddr, val);
		if (ret < 0)
			return ret;
	}
...
static const struct file_operations s2mpu11_i2caddr_fops = {
	.open = simple_open,
	.read = s2mpu11_i2caddr_read,
	.write = s2mpu11_i2caddr_write,
	.llseek = default_llseek,
};
static const struct file_operations s2mpu11_i2cdata_fops = {
	.open = simple_open,
	.read = s2mpu11_i2cdata_read,
	.write = s2mpu11_i2cdata_write,
	.llseek = default_llseek,
};
#endif
...
#ifdef CONFIG_DEBUG_FS
	dbgi2c = s2mpu11->i2c;
	s2mpu11_root = debugfs_create_dir("s2mpu11-regs", NULL);
	s2mpu11_i2caddr = debugfs_create_file("i2caddr", 0644, s2mpu11_root, NULL, &s2mpu11_i2caddr_fops);
	s2mpu11_i2cdata = debugfs_create_file("i2cdata", 0644, s2mpu11_root, NULL, &s2mpu11_i2cdata_fops);
#endif
...
#ifdef CONFIG_DEBUG_FS
	debugfs_remove_recursive(s2mpu11_i2cdata);
	debugfs_remove_recursive(s2mpu11_i2caddr);
	debugfs_remove_recursive(s2mpu11_root);
#endif
