...
struct init_vclk exynos9630_vra_hwacg_vclks[] __initdata = {
	HWACG_VCLK(GATE_SYSMMU_VRA_QCH_S1, SYSMMU_VRA_QCH_S1, "GATE_SYSMMU_VRA_QCH_S1", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_VRA_QCH_S2, SYSMMU_VRA_QCH_S2, "GATE_SYSMMU_VRA_QCH_S2", NULL, 0, VCLK_GATE, NULL),
