...
struct init_vclk exynos9630_aud_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_ABOX_QCH_FM, ABOX_QCH_FM, "GATE_ABOX_QCH_FM", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9630_cmgp_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_I3C_CMGP_QCH, I3C_CMGP_QCH, "GATE_I3C_CMGP_QCH", NULL, 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9630_dpu_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_SYSMMU_DPU_QCH_S1, SYSMMU_DPU_QCH_S1, "GATE_SYSMMU_DPU_QCH_S1", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_DPU_QCH_S2, SYSMMU_DPU_QCH_S2, "GATE_SYSMMU_DPU_QCH_S2", NULL, 0, VCLK_GATE, NULL),
};
...
struct init_vclk exynos9630_peri_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(UMUX_CLKCMU_PERI_UART_DBG, MUX_CLKCMU_PERI_UART_DBG, "UMUX_CLKCMU_PERI_UART_DBG", "UMUX_CLKCMU_PERI_BUS_USER", 0, VCLK_GATE, NULL),
	HWACG_VCLK(UMUX_CLKCMU_PERI_USI_I2C_USER, MUX_CLKCMU_PERI_USI_I2C_USER, "UMUX_CLKCMU_PERI_USI_I2C_USER", "UMUX_CLKCMU_PERI_BUS_USER", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_MMC_CARD_QCH, MMC_CARD_QCH, "GATE_MMC_CARD_QCH", "UMUX_CLKCMU_PERI_BUS_USER", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9630_usb_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(UMUX_CLKCMU_USB_USB31DRD_USER, MUX_CLKCMU_USB_USB31DRD_USER, "UMUX_CLKCMU_USB_USB31DRD_USER", "UMUX_CLKCMU_USB_BUS_USER", 0, VCLK_GATE, NULL),
	HWACG_VCLK(UMUX_CLKCMU_USB_USBDP_DEBUG_USER, MUX_CLKCMU_USB_USBDP_DEBUG_USER, "UMUX_CLKCMU_USB_USBDP_DEBUG_USER", "UMUX_CLKCMU_USB_USB31DRD_USER", 0, VCLK_GATE, NULL),
	HWACG_VCLK(UMUX_CLKCMU_USB_DPGTC_USER, MUX_CLKCMU_USB_DPGTC_USER, "UMUX_CLKCMU_USB_DPGTC_USER", "UMUX_CLKCMU_USB_BUS_USER", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9630_vra_hwacg_vclks[] __initdata = {
	HWACG_VCLK(UMUX_CLKCMU_VRA_BUS_USER, MUX_CLKCMU_VRA_BUS_USER, "UMUX_CLKCMU_VRA_BUS_USER", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(UMUX_CLKCMU_VRA_CLAHE_USER, MUX_CLKCMU_VRA_CLAHE_USER, "UMUX_CLKCMU_VRA_CLAHE_USER", "UMUX_CLKCMU_VRA_BUS_USER", 0, 0, NULL),
...
struct init_vclk exynos9630_peri_vclks[] __initdata = {
	...
	VCLK(UART_DBG, VCLK_DIV_CLK_PERI_UART_DBG, "UART_DBG", 0, 0, NULL),
