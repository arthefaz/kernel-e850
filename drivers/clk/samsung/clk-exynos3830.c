...
struct init_vclk exynos3830_is_hwacg_vclks[] __initdata = {
	HWACG_VCLK(GATE_CSIS0_QCH, CSIS0_QCH, "GATE_CSIS0_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_CSIS1_QCH, CSIS1_QCH, "GATE_CSIS1_QCH", NULL, 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_CSIS2_QCH, CSIS2_QCH, "GATE_CSIS2_QCH", NULL, 0, VCLK_GATE, NULL),
