...
#define SLSI_QSD_SW_FEATURE_ID_LEN 1
#define SLSI_QSF_SW_FEATURE_LEN_LEN 1
...
#define SLSI_QSF_SET_WIFI_STANDARD(hw_feature, wifi_standard)   (hw_feature |= \
                                  (wifi_standard << SLSI_QSF_WIFI_STANDARD_POS) & SLSI_QSF_WIFI_STANDARD_MASK)
...
#define SLSI_QSF_SET_LOW_PWR_RX_CORE(hw_feature, low_rx_core)   (hw_feature |= \
                                    (low_rx_core << SLSI_QSF_LOW_RX_CORE_POS) & SLSI_QSF_LOW_RX_CORE_MASK)
...
#define SLSI_QSF_SET_NUMBER_OF_CORES(hw_feature, main_cores)     (hw_feature |= \
                                    (main_cores << SLSI_QSF_MAIN_CORES_POS) & SLSI_QSF_MAIN_CORES_MASK)
...
#define SLSI_QSF_SET_CONCURRENCY_MODES(hw_feature, supp_conc_mode)  (hw_feature |= \
                                      (supp_conc_mode << SLSI_QSF_SUPP_CONC_MODE_POS) & SLSI_QSF_SUPP_CONC_MODE_MASK)
...
#define SLSI_QSF_SET_HW_FEATURE_LEN(hw_feature, hw_feature_len)   (hw_feature |= \
                                   (hw_feature_len << SLSI_QSF_HW_FEATURE_LEN_POS) & SLSI_QSF_HW_FEATURE_LEN_MASK)

#define SLSI_SUPPORTED_NSS_IS_VALID(caps)   (caps[12] & (BIT(0) | BIT(1)))
...
#define SLSI_GET_DYNAMIC_DWELL_CONTROL(misc_features_activated)  (misc_features_activated[3] | BIT(1))
#define SLSI_GET_ENHANCED_PASSIVE_SCAN(misc_features_activated)  (misc_features_activated[3] | BIT(2))
...
#define SLSI_GET_SUPPORT_5G(misc_features_activated)          (misc_features_activated[6] | BIT(1))
#define SLSI_GET_SUPPORT_6G(misc_features_activated)          (misc_features_activated[6] | BIT(2))
...
#define SLSI_GET_VALID_CHAN_API_SUPPORTED    BIT(8)
...
#define SLSI_GET_EMERGENCY_ROAMING_TRIGGER(misc_features_activated)     (misc_features_activated[7] & BIT(1))
#define SLSI_GET_BTM_ROAMING_TRIGGER(misc_features_activated)           (misc_features_activated[7] & BIT(2))
#define SLSI_GET_IDLE_ROAMING_TRIGGER(misc_features_activated)          (misc_features_activated[7] & BIT(3))
#define SLSI_GET_WTC_ROAMING_TRIGGER(misc_features_activated)           (misc_features_activated[7] & BIT(4))
#define SLSI_GET_BT_COEX_ROAMING(misc_features_activated)               (misc_features_activated[7] & BIT(5))
#define SLSI_GET_ROAMING_BETWEEN_WPA_AND_WPA2(misc_features_activated)  (misc_features_activated[7] & BIT(6))
#define SLSI_GET_MANAGE_CHAN_LIST_API(misc_features_activated)          (misc_features_activated[7] & BIT(7))
#define SLSI_GET_ADAPTIVE_11R(misc_features_activated)                  (misc_features_activated[8] & BIT(0))
#define SLSI_GET_ROAMING_CTRL_API_1_2(misc_features_activated)          (misc_features_activated[8] & BIT(1))
#define SLSI_GET_ROAMING_CTRL_API_3_4(misc_features_activated)          (misc_features_activated[8] & BIT(2))
#define SLSI_GET_ROAMING_CTRL_API_5(misc_features_activated)            (misc_features_activated[8] & BIT(3))
...
#define SLSI_GET_SUPPORT_CTRL_FRAMES(misc_features_activated) (misc_features_activated[10] & BIT(1))
#define SLSI_GET_SUPPORT_DATA_FRAMES(misc_features_activated) (misc_features_activated[10] & BIT(2))

#define SLSI_MGMT_FRAME_ENABLED BIT(0)
#define SLSI_CTRL_FRAME_ENABLED BIT(1)
#define SLSI_DATA_FRAME_ENABLED BIT(2)
#define SLSI_GET_SUPPORT_SAE_H2E(misc_features_activated)       (misc_features_activated[11] & BIT(0))
#define SLSI_GET_SUPPORT_SAE_FT(misc_features_activated)        (misc_features_activated[11] & BIT(1))
#define SLSI_GET_SUPPORT_SUITE_B(misc_features_activated)       (misc_features_activated[11] & BIT(2))
#define SLSI_GET_SUPPORT_SUITE_B_192(misc_features_activated)   (misc_features_activated[11] & BIT(3))
#define SLSI_GET_SUPPORT_SHA_256(misc_features_activated)       (misc_features_activated[11] & BIT(4))
#define SLSI_GET_SUPPORT_SHA_384(misc_features_activated)       (misc_features_activated[11] & BIT(5))
#define SLSI_GET_SUPPORT_SHA_256_FT(misc_features_activated)    (misc_features_activated[11] & BIT(6))
#define SLSI_GET_SUPPORT_SHA_384_FT(misc_features_activated)    (misc_features_activated[11] & BIT(7))
#define SLSI_GET_SUPPORT_OWE(misc_features_activated)           (misc_features_activated[12] & BIT(0))
...
#define SLSI_GET_P2P_LISTEN_OFFLOADING(misc_features_activated)       (misc_features_activated[13] & BIT(3))
#define SLSI_GET_NOA_PS_P2P(misc_features_activated)                  (misc_features_activated[13] & BIT(4))
#define SLSI_GET_TDLS_OFFCHANNEL(misc_features_activated)             (misc_features_activated[13] & BIT(5))
#define SLSI_TDLS_CAPABILITY_ENHANCE(misc_features_activated)         (misc_features_activated[13] & BIT(6))
#define SLSI_GET_MAX_NAN_NDPS(misc_features_activated)                (misc_features_activated[14] & 0xF0)
#define SLSI_GET_STA_P2P_SUPPORT(misc_features_activated)             (misc_features_activated[15] & BIT(0))
#define SLSI_GET_STA_SOFTAP_SUPPORT(misc_features_activated)          (misc_features_activated[15] & BIT(1))
#define SLSI_GET_STA_NAN_SUPPORT(misc_features_activated)             (misc_features_activated[15] & BIT(2))
#define SLSI_GET_STA_TDLS_SUPPORT(misc_features_activated)            (misc_features_activated[15] & BIT(3))
#define SLSI_GET_STA_SOFTAP_P2P_SUPPORT(misc_features_activated)      (misc_features_activated[15] & BIT(4))
#define SLSI_GET_STA_SOFTAP_NAN_SUPPORT(misc_features_activated)      (misc_features_activated[15] & BIT(5))
#define SLSI_GET_STA_P2P_P2P_SUPPORT(misc_features_activated)         (misc_features_activated[15] & BIT(6))
#define SLSI_GET_STA_P2P_NAN_SUPPORT(misc_features_activated)         (misc_features_activated[15] & BIT(7))
...
#define SLSI_GET_STA_P2P_TDLS_SUPPORT(misc_features_activated)        (misc_features_activated[16] & BIT(0))
#define SLSI_GET_STA_SOFTAP_TDLS_SUPPORT(misc_features_activated)     (misc_features_activated[16] & BIT(1))
#define SLSI_GET_STA_NAN_TDLS_SUPPORT(misc_features_activated)        (misc_features_activated[16] & BIT(2))
#define SLSI_GET_STA_SOFTAP_P2P_TDLS_SUPPORT(misc_features_activated) (misc_features_activated[16] & BIT(3))
#define SLSI_GET_STA_SOFTAP_NAN_TDLS_SUPPORT(misc_features_activated) (misc_features_activated[16] & BIT(4))
#define SLSI_GET_STA_P2P_P2P_TDLS_SUPPORT(misc_features_activated)    (misc_features_activated[16] & BIT(5))
#define SLSI_GET_STA_P2P_NAN_TDLS_SUPPORT(misc_features_activated)    (misc_features_activated[16] & BIT(6))
...
#define SLSI_GET_SAMSUNG_NAN_6E_SUPPORT(misc_features_activated)      (misc_features_activated[17] & BIT(1))
#define SLSI_GET_NAN_VERSION(misc_features_activated)                 (misc_features_activated[17] & (BIT(3) | BIT(4) | BIT(5)))
...
#define SLSI_GET_BSSI_INFO_API_SUPP_ENABLED      BIT(0)
#define SLSI_GET_ASSOC_REJECT_INFO_API_ENABLED   BIT(1)
#define SLSI_GET_STA_INFO_API_SUPP_ENABLED       BIT(2)
...
static struct kobj_attribute qsf_attr = __ATTR(feature, 0660, sysfs_show_qsf, NULL);
#if defined(SCSC_SEP_VERSION) && SCSC_SEP_VERSION >= 12
...
static u32 slsi_get_antenna_from_ht_caps(u8 *caps)
{
	...
	if (SLSI_SUPPORTED_NSS_IS_VALID(caps) == 3)
...
static u32 slsi_get_antenna_from_vht_caps(u8 *caps)
{
	...
	if ((tx_max_nss == 0) || (0 == rx_max_nss))
		return 1;
	if (tx_max_nss > rx_max_nss)
		return tx_max_nss;
	else
		return rx_max_nss;
...
static u32 slsi_get_antenna_from_he_caps(u8 *caps)
{
	...
	if (tx_max_nss_80 < tx_max_nss_160)
		tx_max_nss = tx_max_nss_160;
	else
		tx_max_nss = tx_max_nss_80;
	...
	if (rx_max_nss_80 < rx_max_nss_160)
		rx_max_nss = rx_max_nss_160;
	else
		rx_max_nss = rx_max_nss_80;
...
static ssize_t sysfs_show_qsf(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	...
	u32 antenna = 0;
	u32 hw_feature_len = 4 ,twt = 0, mhs = 0, ncho = 0, security = 0, twt_control = 0;
	u8 pno = 0, wifi_optimizer = 0, scheduled_pm = 0, delayed_wakeup = 0, rfc_8325 = 0;
	u8 assurance = 0, big_data = 0;
	u32 roaming = 0, fw_build_id = 0;
	u8 p2p[6] = {0};
	struct slsi_dev *sdev = slsi_get_sdev();
	u8 misc_features_activated[18] = {0};
	u32 appendix_versions = 0;
	...
	u32 p2p_listen_offloading = 0;
	u32 noa_ps_p2p = 0;
	u32 tdls_offchannel = 0;
	u32 tdls_capability_enhance = 0;
	u32 max_nan_ndps = 0;
	u32 sta_p2p = 0;
	u32 sta_softap = 0;
	u32 sta_nan = 0;
	u32 sta_tdls = 0;
	u32 sta_softap_p2p = 0;
	u32 sta_softap_nan = 0;
	u32 sta_p2p_p2p = 0;
	u32 sta_p2p_nan = 0;
	u32 sta_p2p_tdls = 0;
	u32 sta_softap_tdls = 0;
	u32 sta_nan_tdls = 0;
	u32 sta_softap_p2p_tdls = 0;
	u32 sta_softap_nan_tdls = 0;
	u32 sta_p2p_p2p_tdls = 0;
	u32 sta_p2p_nan_tdls = 0;
	u32 standard_nan_6e = 0;
	u32 samsung_nan_6e = 0;
	u32 nan_version = 0;

	u32 get_bssi_info_api_supp = 1;
	u32 get_assoc_reject_info_api_supp = 1;
	...
	u32 fils_sha_256 = 0;
	u32 fils_sha_384 = 0;
	u32 fils_sha_256_ft = 0;
	u32 fils_sha_384_ft = 0;
	u32 owe = 0;
	u32 dual_interface = 0;
	u32 roaming_major_number = 0;
	u32 roaming_minor_number = 0;
	u32 high_chan_utilization_trigger = 0;
	u32 emergency_roaming_trigger = 0;
	u32 btm_roaming_trigger = 0;
	u32 idle_roaming_trogger = 0;
	u32 wtc_roaming_trigger = 0;
	u32 bt_coex_roaming_trigger = 0;
	u32 roaming_bwtween_wpa_and_wpa2 = 0;
	u32 manage_chan_list_api = 0;
	u32 adaptive_11r = 0;
	u32 roaming_ctrl_api_1_2 = 0;
	u32 ncho_major = 0;
	u32 ncho_minor = 0;
	u32 mgmt_frame = 0;
	u32 ctrl_frame = 0;
	u32 data_frame = 0;
	u32 roaming_ctrl_api_3_4 = 0;
	u32 roaming_ctrl_api_5 = 0;
	u32 support_5g = 0;
	u32 support_6g = 0;

	u32 country_code_set_hal_api = 1;
	u32 get_valid_chan_hal_api = 1;
	u32 pno_enabled = 1;
	u32 pno_in_un_assocociated = 1;

	u32 pno_in_associated = 0;
	u32 twt_req = 0;
	u32 twt_broadcast = 0;
	u32 wifi_optimizer_support = 0;
	u32 sched_pm_support = 0;
	u32 dynamic_dwell_control = 0;
	u32 enhanced_passive_scan = 0;
	u32 delayed_wakeup_supp = 0;
	u32 twt_flexible = 0;
	u32 min_service_period = 0;
	u32 min_sleep_period = 0;
	bool twt_active = false, he_softap_active = false, wpa3_active = false;
	bool tdls_active = false, tdls_peer_uapsd_active = false, nan_fast_connect = false, he_active = false;
	u16 max_tdls_cli = 0;
	u8 ht_caps[21] = {0}, vht_caps[12] = {0}, he_caps[32] = {0};
	...
	if (values[0].type == SLSI_MIB_TYPE_BOOL)
		he_active = values[0].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 0);

	if (values[1].type == SLSI_MIB_TYPE_BOOL)
		twt_active = values[1].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 1);
	if (values[2].type == SLSI_MIB_TYPE_BOOL)
		he_softap_active = values[2].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 2);
	if (values[3].type == SLSI_MIB_TYPE_BOOL)
		wpa3_active = values[3].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 3);
	if (values[4].type == SLSI_MIB_TYPE_BOOL)
		tdls_active = values[4].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 4);
	if (values[5].type == SLSI_MIB_TYPE_BOOL)
		tdls_peer_uapsd_active = values[5].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 5);
	if (values[6].type == SLSI_MIB_TYPE_BOOL)
		nan_fast_connect = values[6].u.boolValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 6);
	if (values[7].type == SLSI_MIB_TYPE_UINT)
		max_tdls_cli = values[7].u.uintValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 7);
	if (values[8].type == SLSI_MIB_TYPE_OCTET && values[8].u.octetValue.dataLength >= 21)
		memcpy(ht_caps, values[8].u.octetValue.data, 21);
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 8);
	if (values[9].type == SLSI_MIB_TYPE_OCTET && values[9].u.octetValue.dataLength >= 12)
		memcpy(vht_caps, values[9].u.octetValue.data, 12);
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 9);
	if (values[10].type == SLSI_MIB_TYPE_OCTET && values[10].u.octetValue.dataLength >= 32)
		memcpy(he_caps, values[10].u.octetValue.data, 32);
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 10);
	if (values[11].type == SLSI_MIB_TYPE_OCTET && values[11].u.octetValue.dataLength >= 18)
		memcpy(misc_features_activated, values[11].u.octetValue.data, 18);
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 11);
	if (values[12].type == SLSI_MIB_TYPE_OCTET && values[10].u.octetValue.dataLength >= 4)
		memcpy(&appendix_versions, values[12].u.octetValue.data, 4);
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 12);
	if (values[13].type == SLSI_MIB_TYPE_UINT)
		fw_build_id = values[13].u.uintValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 13);
	if (values[14].type == SLSI_MIB_TYPE_UINT)
		twt_control = values[14].u.uintValue;
	else
		SLSI_ERR(sdev, "invalid type for index: %d\n", 14);

	p2p_listen_offloading = SLSI_GET_P2P_LISTEN_OFFLOADING(misc_features_activated);
	noa_ps_p2p = SLSI_GET_NOA_PS_P2P(misc_features_activated);
	tdls_offchannel = SLSI_GET_TDLS_OFFCHANNEL(misc_features_activated);
	tdls_capability_enhance = SLSI_TDLS_CAPABILITY_ENHANCE(misc_features_activated);
	max_nan_ndps = SLSI_GET_MAX_NAN_NDPS(misc_features_activated);
	sta_p2p = SLSI_GET_STA_P2P_SUPPORT(misc_features_activated);
	sta_softap = SLSI_GET_STA_SOFTAP_SUPPORT(misc_features_activated);
	sta_nan = SLSI_GET_STA_NAN_SUPPORT(misc_features_activated);
	sta_tdls = SLSI_GET_STA_TDLS_SUPPORT(misc_features_activated);
	sta_softap_p2p = SLSI_GET_STA_SOFTAP_P2P_SUPPORT(misc_features_activated);
	sta_softap_nan = SLSI_GET_STA_SOFTAP_NAN_SUPPORT(misc_features_activated);
	sta_p2p_p2p = SLSI_GET_STA_P2P_P2P_SUPPORT(misc_features_activated);
	sta_p2p_nan = SLSI_GET_STA_P2P_NAN_SUPPORT(misc_features_activated);
	sta_p2p_tdls = SLSI_GET_STA_P2P_TDLS_SUPPORT(misc_features_activated);
	sta_softap_tdls = SLSI_GET_STA_SOFTAP_TDLS_SUPPORT(misc_features_activated);
	sta_nan_tdls = SLSI_GET_STA_NAN_TDLS_SUPPORT(misc_features_activated);
	sta_softap_p2p_tdls = SLSI_GET_STA_SOFTAP_P2P_TDLS_SUPPORT(misc_features_activated);
	sta_softap_nan_tdls = SLSI_GET_STA_SOFTAP_NAN_TDLS_SUPPORT(misc_features_activated);
	sta_p2p_p2p_tdls = SLSI_GET_STA_P2P_P2P_TDLS_SUPPORT(misc_features_activated);
	sta_p2p_nan_tdls = SLSI_GET_STA_P2P_NAN_TDLS_SUPPORT(misc_features_activated);
	standard_nan_6e = SLSI_GET_STANDARD_NAN_6E_SUPPORT(misc_features_activated);
	samsung_nan_6e = SLSI_GET_SAMSUNG_NAN_6E_SUPPORT(misc_features_activated);
	nan_version = SLSI_GET_NAN_VERSION(misc_features_activated);
	sae_h2e = SLSI_GET_SUPPORT_SAE_H2E(misc_features_activated);
	sae_ft = SLSI_GET_SUPPORT_SAE_FT(misc_features_activated);
	suite_b = SLSI_GET_SUPPORT_SUITE_B(misc_features_activated);
	suite_b_192 = SLSI_GET_SUPPORT_SUITE_B_192(misc_features_activated);
	fils_sha_256 = SLSI_GET_SUPPORT_SHA_256(misc_features_activated);
	fils_sha_384 = SLSI_GET_SUPPORT_SHA_384(misc_features_activated);
	fils_sha_256_ft = SLSI_GET_SUPPORT_SHA_256_FT(misc_features_activated);
	fils_sha_384_ft = SLSI_GET_SUPPORT_SHA_384_FT(misc_features_activated);
	owe = SLSI_GET_SUPPORT_OWE(misc_features_activated);
	dual_interface = SLSI_GET_DUAL_IFACE_SUPPORT(misc_features_activated);
	roaming_major_number = SLSI_GET_ROAMING_MAJOR_NUMBER(appendix_versions);
	roaming_minor_number = SLSI_GET_ROAMING_MINOR_NUMBER(appendix_versions);
	high_chan_utilization_trigger = SLSI_GET_HIGH_CHAN_UTILIZATON_TRIGGER(misc_features_activated);
	emergency_roaming_trigger = SLSI_GET_EMERGENCY_ROAMING_TRIGGER(misc_features_activated);
	btm_roaming_trigger = SLSI_GET_BTM_ROAMING_TRIGGER(misc_features_activated);
	idle_roaming_trogger = SLSI_GET_IDLE_ROAMING_TRIGGER(misc_features_activated);
	wtc_roaming_trigger = SLSI_GET_WTC_ROAMING_TRIGGER(misc_features_activated);
	bt_coex_roaming_trigger = SLSI_GET_BT_COEX_ROAMING(misc_features_activated);
	roaming_bwtween_wpa_and_wpa2 = SLSI_GET_ROAMING_BETWEEN_WPA_AND_WPA2(misc_features_activated);
	manage_chan_list_api = SLSI_GET_MANAGE_CHAN_LIST_API(misc_features_activated);
	adaptive_11r = SLSI_GET_ADAPTIVE_11R(misc_features_activated);
	roaming_ctrl_api_1_2 = SLSI_GET_ROAMING_CTRL_API_1_2(misc_features_activated);
	ncho_major = SLSI_GET_NCHO_MAJOR_NUMBER(appendix_versions);
	ncho_minor = SLSI_GET_NCHO_MINOR_NUMBER(appendix_versions);
	mgmt_frame = SLSI_GET_SUPPORT_MGMT_FRAMES(misc_features_activated);
	ctrl_frame = SLSI_GET_SUPPORT_CTRL_FRAMES(misc_features_activated);
	data_frame = SLSI_GET_SUPPORT_DATA_FRAMES(misc_features_activated);
	roaming_ctrl_api_3_4 = SLSI_GET_ROAMING_CTRL_API_3_4(misc_features_activated);
	roaming_ctrl_api_5 = SLSI_GET_ROAMING_CTRL_API_5(misc_features_activated);
	support_5g = SLSI_GET_SUPPORT_5G(misc_features_activated);
	support_6g = SLSI_GET_SUPPORT_6G(misc_features_activated);
	pno_in_associated = SLSI_GET_PNO_STATE_IN_ASSOC(misc_features_activated);
	twt_req = SLSI_GET_TWT_REQ(twt_control);
	twt_broadcast = SLSI_GET_TWT_BROADCAST(twt_control);
	wifi_optimizer_support = SLSI_GET_WIFI_OPTIMIZER_SUPPORT(misc_features_activated);
	sched_pm_support = SLSI_GET_SCHED_PM_SUPPORT(misc_features_activated);
	dynamic_dwell_control = SLSI_GET_DYNAMIC_DWELL_CONTROL(misc_features_activated);
	enhanced_passive_scan = SLSI_GET_ENHANCED_PASSIVE_SCAN(misc_features_activated);
	delayed_wakeup_supp = SLSI_GET_DELAYED_WAKEUP_SUPPORT(misc_features_activated);
	twt_flexible = SLSI_GET_TWT_FLEXIBLE(twt_control);
	min_service_period = SLSI_GET_TWT_MIN_SERVICE_PERIOD(misc_features_activated);
	min_sleep_period = SLSI_GET_TWT_min_sleep_period(misc_features_activated);

	bytes += scnprintf(buf, buf_size, "%08x", fw_build_id);
	bytes += scnprintf(buf + bytes, buf_size - bytes, "%02x%02x%02x", sol_name[0], sol_name[1], sol_name[2]);
	...
	bytes += scnprintf(buf + bytes, buf_size - bytes, "%08x", hw_feature);

	sw_feature_len_offset = bytes;
	bytes += 8;
	if (pno_enabled)
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(pno));
	if (twt_active)
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(twt));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(wifi_optimizer));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(scheduled_pm));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(delayed_wakeup));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(rfc_8325));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(mhs));

	if (roaming_major_number)
		roaming |= roaming_major_number;
	if (roaming_minor_number)
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(roaming));
	if (ncho_major)
		ncho |= ncho_major;
	if (ncho_minor)
		ncho |= ncho_minor << 8;
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(ncho));
	assurance = misc_features_activated[9] & SLSI_QSF_SW_FEATURE_ASSURANCE_MASK;
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(assurance));
	if (mgmt_frame)
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(pcap_frame_logging));

	if (sae_h2e)
		security |= SLSI_SUPPORT_SAE_H2E;
	if (sae_ft)
		security |= SLSI_SUPPORT_SAE_FT;
	if (suite_b)
		security |= SLSI_SUPPORT_SUITE_B;
	if (suite_b_192)
		security |= SLSI_SUPPORT_SUITE_B_192;
	if (fils_sha_256)
		security |= SLSI_SUPPORT_SHA_256;
	if (fils_sha_384)
		security |= SLSI_SUPPORT_SHA_384;
	if (fils_sha_256_ft)
		security |= SLSI_SUPPORT_SHA_256_FT;
	if (fils_sha_384_ft)
		security |= SLSI_SUPPORT_SHA_384_FT;
	if (owe)
		security |= SLSI_SUPPORT_OWE;
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(security));
...
#endif
	if (p2p_listen_offloading)
		p2p[0] |= SLSI_QSF_P2P_LISTEN_OFFLOADING_SUPPORTED;
	if (noa_ps_p2p)
		p2p[0] |= SLSI_QSF_NOA_PS_P2P_SUPPORTED;
	if (tdls_offchannel)
		p2p[0] |= SLSI_QSF_TDLS_OFFCHANNEL_SUPPORTED;
	if (tdls_capability_enhance)
		p2p[0] |= SLSI_QSF_TDLS_CAPA_ENHANCE_SUPPORTED;
	...
	if (sta_p2p)
		p2p[2] |= SLSI_QSF_STA_P2P_SUPPORTED;
	if (sta_softap)
		p2p[2] |= SLSI_QSF_STA_SOFTAP_SUPPORTED;
	if (sta_nan)
		p2p[2] |= SLSI_QSF_STA_NAN_SUPPORTED;
	if (sta_tdls)
		p2p[2] |= SLSI_QSF_STA_TDLS_SUPPORTED;
	if (sta_softap_p2p)
		p2p[2] |= SLSI_QSF_STA_SOFTAP_P2P_SUPPORTED;
	if (sta_softap_nan)
		p2p[2] |= SLSI_QSF_STA_SOFTAP_NAN_SUPPORTED;
	if (sta_p2p_p2p)
		p2p[2] |= SLSI_QSF_STA_P2P_P2P_SUPPORTED;
	if (sta_p2p_nan)
		p2p[2] |= SLSI_QSF_STA_P2P_NAN_SUPPORTED;
	if (sta_p2p_tdls)
		p2p[3] |= SLSI_QSF_STA_P2P_TDLS_SUPPORTED;
	if (sta_softap_tdls)
		p2p[3] |= SLSI_QSF_STA_SOFTAP_TDLS_SUPPORTED;
	if (sta_nan_tdls)
		p2p[3] |= SLSI_QSF_STA_NAN_TDLS_SUPPORTED;
	if (sta_softap_p2p_tdls)
		p2p[3] |= SLSI_QSF_STA_SOFTAP_P2P_TDLS_SUPPORTED;
	if (sta_softap_nan_tdls)
		p2p[3] |= SLSI_QSF_STA_SOFTAP_NAN_TDLS_SUPPORTED;
	if (sta_p2p_nan_tdls)
		p2p[3] |= SLSI_QSF_STA_P2P_NAN_TDLS_SUPPORTED;
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(p2p));
	...
	sw_feature_len += 2 * (SLSI_QSD_SW_FEATURE_ID_LEN + SLSI_QSF_SW_FEATURE_LEN_LEN + sizeof(big_data));
	bytes += scnprintf(buf + sw_feature_len_offset, buf_size - sw_feature_len_offset, "%08x", sw_feature_len);
	return bytes;
}
...
void slsi_create_sysfs_qsf(void)
{
	int r;
...
void slsi_destroy_sysfs_qsf(void)
{
	if (!wifi_kobj_ref)
		return;
