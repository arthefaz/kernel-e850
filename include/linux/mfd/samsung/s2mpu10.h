/*
 * s2mpu10.h - Driver for the s2mpu10
 *
...
#ifndef __S2MPU10_MFD_H__
#define __S2MPU10_MFD_H__
#include <linux/platform_device.h>
#include <linux/regmap.h>

#define MFD_DEV_NAME "s2mpu10"
/**
 * sec_regulator_data - regulator data
 * @id: regulator id
 * @initdata: regulator init data (contraints, supplies, ...)
 */
struct s2mpu10_regulator_data {
	int id;
...
struct s2mpu10_platform_data {
	int irq_base;
	bool wakeup;

	int num_regulators;
	struct	s2mpu10_regulator_data *regulators;
