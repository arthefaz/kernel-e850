...
#define SMC_CMD_PUSH_KERNEL_TEXT_INFO	(-126)
...
/* For FMP/SMU Ctrl */
#define SMC_CMD_FMP_SECURITY		(0x8C2001810)
#define SMC_CMD_FMP_DISK_KEY_STORED	(0x82001820)
#define SMC_CMD_FMP_DISK_KEY_SET	(0x82001830)
#define SMC_CMD_FMP_DISK_KEY_CLEAR	(0x82001840)
#define SMC_CMD_SMU			(0x82001850)
#define SMC_CMD_FMP_SMU_RESUME		(0x82001860)
#define SMC_CMD_FMP_SMU_DUMP		(0x82001870)
#define SMC_CMD_UFS_LOG			(0x82001880)
#define SMC_CMD_FMP_KW_MODE		(0x82001890)
#define SMC_CMD_FMP_KW_INDATASWAP	(0x820018A0)
#define SMC_CMD_FMP_KW_SYSREG		(0x820018B0)
...
#define SMC_DRM_G3D_POWER_ON		(0x8200211C)
#define SMC_DRM_G3D_POWER_OFF		(0x8200211D)
...
static inline unsigned long exynos_smc(unsigned long cmd, unsigned long arg0, unsigned long arg1, unsigned long arg2)
{
	struct arm_smccc_res res;
	arm_smccc_smc(cmd, arg0, arg1, arg2, 0, 0, 0, 0, &res);
	return (unsigned long)res.a0;
}
static inline unsigned long exynos_smc_readsfr(unsigned long addr, unsigned long *val)
{
	struct arm_smccc_res res;

	addr = SMC_REG_ID_SFR_R(addr);
